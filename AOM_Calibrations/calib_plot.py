...
frequency_range = np.array([362,400.5,402.5,407.5,409.5,413,413.5,415.5])
#frequency_range = np.array
for freq in frequency_range:
    plot_optical_power_vs_rf_power(results, rf_power_fractions, freq, smooth=False, save=False)
